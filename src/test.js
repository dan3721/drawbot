...
// ensure calcTranslation is sane
const TRANSITION_INFO = drawbot.calcTranslation(5, 5, 5, 6)
assert('pulse A is 1995', 1995, TRANSITION_INFO[0])
assert('pulse B is 1005', 1005, TRANSITION_INFO[1])
assert('execution time is 26', 26, TRANSITION_INFO[2])
assert('origin point', [125.94, 54.06], TRANSITION_INFO[3])
assert('target point', [134.59, 45.41], TRANSITION_INFO[4])
